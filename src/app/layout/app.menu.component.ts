    ...
    this.model = [
      {
        label: 'Home',
        items: [
          { label: 'Dashboard', icon: 'pi pi-fw pi-home', routerLink: ['/', tenantIdentifier] },
          { label: 'Programs', icon: 'pi pi-fw pi-list', routerLink: ['/', tenantIdentifier, 'programs'] },
          { label: 'Curriculums', icon: 'pi pi-fw pi-book', routerLink: ['/', tenantIdentifier, 'curriculums'] },
